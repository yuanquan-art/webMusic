...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/zhuanji',
        component: ()=>import('../components/Home/zhuanJi/ZhuanJi.vue')
      },
      {
        path: '/zhibo',
        component: ()=>import('../components/Home/ZhiBo/Zhibo.vue')
      }   
    ]   
  },
  {
  ...
  {
   path: '/videoBofang',
   component: ()=>import('../components/Home/Videozujian/VideoBofang.vue')
  },     
  {
    path: '/mvBofang',
    component: ()=> import('../components/Home/MV/MVBofang.vue')
  }
]
