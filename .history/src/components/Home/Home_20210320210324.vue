        ...
        <el-row>
          ...
          <el-col :span="9" class="top-right">
            <el-row class="top-zujian">
              <el-col :span="1">
                <i class="iconfont iconiconset01100"></i>
              </el-col>
              <el-col class="user-unlogin" :span="2">
                <span class="unlogin" @click="showLoginDialogVisible">
                  <i>未登录</i>
...
//   // }
// }
import import { defineComponent, reactive, ref, watch, onMounted, computed, nextTick } from 'vue';
export default {
  setup(props,context){
...
list: [],
     ...
     const showLoginDialogVisible = () => {
        context.loginDialogVisible = !context.loginDialogVisible;
     }
     return {
       loginDialogVisible,
