          ...
          <el-main class="biaotiMessage">
            ...
            <p>
              <img
                ...
                class="avatarUrl"
              />
              <span class="nickname">{{ mvXQCreator.nickname }}</span>
            </p>
            <p>
           ...
           <!-- <p>
               <span class="gedanspan">{{ mvXQCreator.category }}</span>
               <span>
                   {{mvXQCreator.desc }}
               </span>
           </p> -->
...
export default {
  ...
  methods: {
    ...
    async getMusicListXQ() {
      ...
      this.XQCreatorAvatar = mvXQCreator.avatarUrl;
      this.XQCreatorNickName = mvXQCreator.nickname;
      console.log(this.mvXQCreator)
