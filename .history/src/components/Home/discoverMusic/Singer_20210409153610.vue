          ...
          console.log(text)
           if(text == '全部'){
            ...
            return;
              ...
              this.singeGategoryParams.type = '7';
              const {data:res} = await this.$axios.get('/artist/list?limit=100&area='+this.singeGategoryParams.area);
            console.log(res)
            this.singeList = res.artists;
            return;
              ...
              this.singeGategoryParams.type = '96';
              const {data:res} = await this.$axios.get('/artist/list?limit=100&area='+this.singeGategoryParams.area);
            console.log(res)
            this.singeList = res.artists;
            return;
              ...
              this.singeGategoryParams.type = '8';
              const {data:res} = await this.$axios.get('/artist/list?limit=100&area='+this.singeGategoryParams.area);
            console.log(res)
            this.singeList = res.artists;
            return;
              ...
              this.singeGategoryParams.type = '16';
              const {data:res} = await this.$axios.get('/artist/list?limit=100&area='+this.singeGategoryParams.area);
            console.log(res)
            this.singeList = res.artists;
            return;
              ...
              this.singeGategoryParams.type = '0';
              const {data:res} = await this.$axios.get('/artist/list?limit=100&area='+this.singeGategoryParams.area);
            console.log(res)
            this.singeList = res.artists;
            return;
