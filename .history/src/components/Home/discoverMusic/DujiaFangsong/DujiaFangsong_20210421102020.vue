  ...
  data() {
    return {
      ...
      tuijianData: [],
        ...
        id: 'vs',
        autoplay: true,
        url: 'http://vodkgeyttp8.vod.126.net/cloudmusic/obj/core/8335404304/3e11f667ea0f6ffd1b803038cddeed95.mp4?wsSecret=022bc0f6cab25378e8e9afd93dacb827&wsTime=1618970692'
      },
      Player: null
    };
  },
  ...
  methods: {
    ...
    async getVideoXQ() {
      ...
      // this.config.url = resUrl.data.url;
       ...
       this.$refs.config.url = resUrl.data.url;
