    ...
    <div class="dujiaSendParent">
      <el-container>
        <el-aside width="600px">
          ...
          <div class="shipingView" v-if="mvid==14280591">
                <Xgplayer :config="config" @player="Player = $event" ref="audio"/>
          </div>
          <div class="shipingView" v-else-if="mvid==14274595">
                <Xgplayer :config="config1" @player="Player = $event" ref="audio"/>
          </div>
          <!-- 视频信息区域 -->
          <el-container>
...
export default {
  data() {
    return {
      ...
      tuijianData: [],
        ...
        id: 'vs',
        autoplay: true,
        url: 'http://vodkgeyttp8.vod.126.net/cloudmusic/obj/core/8335404304/3e11f667ea0f6ffd1b803038cddeed95.mp4?wsSecret=8c900d178fd503fff29e53c4e4c0ddd0&wsTime=1619163380'
      },
      config1:{
        id: 'vs',
        autoplay: true,
        url: 'http://vodkgeyttp8.vod.126.net/cloudmusic/obj/core/8335404304/3e11f667ea0f6ffd1b803038cddeed95.mp4?wsSecret=18e078a65842e846727a61838d812878&wsTime=1619164000'
      },
      Player: null,
      mvid: 14280591
    };
  ...
  methods: {
    ...
    async getVideoXQ() {
      ...
      //请求mv地址的url
      const {data:resUrl} = await this.$axios.get('http://localhost:3000/mv/url?id='+res.data.id);
      this.config.url = resUrl.data.url;
