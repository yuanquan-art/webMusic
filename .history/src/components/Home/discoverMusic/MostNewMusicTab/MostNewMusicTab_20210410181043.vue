    ...
    <div id="box">
      <div class="tab">
        ...
        <div class="xinMusic" :class="currentIndex == 0 ? 'currentdiv' : ''">
          <el-tabs v-model="activeName" @tab-click="handNewMusic()">
            <el-tab-pane label="全部" name="sec">全部</el-tab-pane>
            <el-tab-pane label="华语" name="second">华语</el-tab-pane>
            <el-tab-pane label="欧美" name="third">欧美</el-tab-pane>
            <el-tab-pane label="韩国" name="fourth"
              >韩国</el-tab-pane
            >
             <el-tab-pane label="日本" name="four"
              >日本</el-tab-pane
            >
          </el-tabs>
        </div>
        <div class="xinMusic" :class="currentIndex == 1 ? 'currentdiv' : ''">
           <el-tabs v-model="activeName">
            <el-tab-pane label="全部" name="s">全部11</el-tab-pane>
            <el-tab-pane label="华语" name="second">华语</el-tab-pane>
            <el-tab-pane label="欧美" name="third">欧美</el-tab-pane>
            <el-tab-pane label="韩国" name="fourth"
              >韩国</el-tab-pane
