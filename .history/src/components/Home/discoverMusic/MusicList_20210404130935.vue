<template>
  <div>
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane :label="item.name" :name="item.name" v-for="item in hotMusicListGategroy" :key="item.id">{{ item.name }}
      </el-tab-pane>
    </el-tabs>
             <span></span>
           </div>
...
export default {
 ...
 methods:{
     ...
     async getHotMusicListGategroy(){
        ...
        //  console.log(this.hotMusicListGategroy);
     },
     // tab点击
     handleClick(tab){
       console.dir(tab.props.name)
     }
 }    
}
</script>
