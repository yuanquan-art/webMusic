    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      >
        ...
        <div v-else-if="activeName == 10">
         <div>
           <div v-for="(item,index) in searchMusicList.albums" :key="index" class="hiddened">
        ...
        <div v-else-if="activeName == 100">
          <div v-for="(item,index) in searchMusicList.artists" :key="index" class="hiddened">
              <img :src="item.picUrl" alt="">
              <span class="hiddenName">{{ item.name }}</span>
        ...
        <div v-else-if="activeName == 1000">
           <div v-for="(item,index) in searchMusicList.playlists" :key="index" class="hiddened">
              <img :src="item.coverImgUrl" alt="">
              <span class="hiddenName">{{ item.name }}</span>
               <span class="size">{{item.creator.nickname }}</span>
              <span class="artistsName">
               mv： {{item.trackCount}}首
              </span>
        ...
        <div v-else-if="activeName == 1002">
          <div v-for="(item,index) in searchMusicList.userprofiles" :key="index" class="hiddened">
