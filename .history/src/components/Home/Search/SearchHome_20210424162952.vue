      ...
      >
        ...
        <div v-else-if="activeName == 1000">
          ...
          >
            ...
            <span class="hiddenName">{{ item.name }}</span>
            <span class="size">by{{ item.creator.nickname }}</span>
              ...
              <div id="remenMusicListGategory">
                <div>
                  ...
                  <div class="tjmusic">
                    <div
                      class="musicList"
                      v-for="(item, index) in searchMusicList.mvs"
                      :key="index"
        ...
        <div v-else-if="activeName == 1009">
         <div
            v-for="(item, index) in searchMusicList.djRadios"
            :key="index"
            class="hiddened"
          >
            <img :src="item.picUrl" alt="" />
            <span class="hiddenName">{{ item.name }}</span>
            <span class="size">by{{ item.dj.nickname }}</span>
          </div>
        </div>
