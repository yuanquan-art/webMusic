    ...
    <div class="privateParent">
      <div class="musicInfo">
        <div class="lunbotu" ref="lunbotu">
          <el-carousel :interval="40000" type="card" height="200px" @change="handleIndex">
          ...
          <div class="musicXXInfo">
                ...
                <p class="geshouInfo">
                    ...
                    <span>歌手{{musicNameArtists[0].name}}</span>
                </p>
              </div>
...
//   },
  ...
  methods: {
    ...
    async getPersonalFM(val) {
      ...
      this.musicNameArtists = res.data[(val?val:0)].artists;
      // 获取歌词
      const {data:musicWord} = await this.$axios.get('/lyric?id='+res.data.id);
