        ...
        <div id="app">
			<div class="box">
				...
				<div class="main clearfix" @mouseover="btnOpen" @mouseout="btnHide">
					<div class="minMain">
						<div class="item" v-for="(item,index) in diantaBannerList" :key="index">
         ...
         export default {
			data() {
				return {
					 // 电台轮播图列表
                  	list: [
						{ imgUrl: '../../assets/vuelbt/img/t1.png' },
						{ imgUrl: '../../assets/vuelbt/img/t2.png' },
						{ imgUrl: '../../assets/vuelbt/img/t3.png' },
						{ imgUrl: '../../assets/vuelbt/img/t4.png' },
						{ imgUrl: '../../assets/vuelbt/img/t5.png' }
					],
