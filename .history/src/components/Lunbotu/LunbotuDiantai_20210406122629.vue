				...
				<div class="main clearfix" @mouseover="btnOpen" @mouseout="btnHide">
					<div class="minMain">
						<div class="item" v-for="(item,index) in list" :key="index">
							<img :src="item.imgUrl+'?param=540y190'"/>
						</div>
					</div>
...
export default  {
          data() {
				return {
					list: [
					    { imgUrl: "http://p1.music.126.net/R3RX2xN7U6mHZfpmOkjpDQ==/109951165866309268.jpg" },
						{ imgUrl: "http://p1.music.126.net/YiyeoIXAt_IALf9CvZxw8w==/109951165866316778.jpg" },
						{ imgUrl: "http://p1.music.126.net/JT3BhZJ0s_w37fFJF2kgvg==/109951165866327536.jpg" },
						{ imgUrl: "http://p1.music.126.net/0dTlwZU8urQyzPfK0W2Pyw==/109951165866312828.jpg" },
                        { imgUrl: "http://p1.music.126.net/0ccBwYmR4ju2VYrG2mcW0Q==/109951165867583590.jpg"}      
					],
