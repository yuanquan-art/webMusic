        ...
        <div id="app">
			<div class="box">
				...
				<div class="main clearfix" @mouseover="btnOpen" @mouseout="btnHide">
					<div class="minMain">
						<div class="item" v-for="(item) in list" :key="item.targetId">
...
export default {
				...
				return {
					...
					pressList: [{ name: '1', isShow: false }, { name: '2', isShow: false }, { name: '3', isShow: false }, { name: '4', isShow: false }, { name: '5', isShow: false },{ name: '6', isShow: false }, { name: '7', isShow: false }, { name: '8', isShow: false }, { name: '9', isShow: false }, { name: '10', isShow: false }],
					numList: ['p0', 'p1', 'p2', 'p3', 'p4','p5', 'p6', 'p7', 'p8', 'p9'],
					imgIndex: 0,
					imgTimer: null,
					btnShow: false
				}
			...
			methods: {
				...
				leftClick() {
					var Item = document.getElementsByClassName('item');
					this.numList.unshift(this.numList[9]);
					this.numList.pop()
					for(var i = 0; i < Item.length; i++) {
						Item[i].className = 'item ' + this.numList[i];
					}
